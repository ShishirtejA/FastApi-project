...
@router.post('/product',status_code=status.HTTP_201_CREATED) # http C0de:-201 i.e the data is added to the database.
...
@router.get('/product/{id}',response_model=schemas.DisplayProduct) # by using the response model we only display the neccesary data of the product,unneccesary data of the product is hidden.
